...
const root = ReactDOM.createRoot(document.getElementById("postSection"));
function PostElem(srcImg, date, title, brief, link) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "date"
  }, date), /*#__PURE__*/React.createElement("h4", null, title), /*#__PURE__*/React.createElement("div", {
...
for (const post of postsArray) {
    const postElem = PostElem(post.srcImg, post.date, post.title, post.brief, post.link)
    root.render(postElem)
}
*/

const postElemArray = postsArray.map(post => PostElem(post.srcImg, post.date, post.title, post.brief, post.link));
root.render(postElemArray);
